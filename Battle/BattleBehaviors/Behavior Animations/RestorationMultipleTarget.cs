...
namespace Grawly.Battle.BehaviorAnimation {
	...
	/// <summary>
	/// This is what should get used for behaviors that have restoration properties but target multiple combatants.
	/// </summary>
	[System.Serializable]
	public class RestorationMultipleTarget : BattleBehaviorAnimation {
		...
		/// </summary>
		private static string descriptionText = "This is what should get used for behaviors that have restoration properties but target multiple combatants.";
		/// <summary>
