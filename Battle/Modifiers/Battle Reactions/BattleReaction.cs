...
namespace Grawly.Battle {
	...
	/// </summary>
	/// <param name="battleReactionSequence">The sequence that this reaction is running in.</param>
	public delegate void BattleReaction(BattleReactionSequence battleReactionSequence);
