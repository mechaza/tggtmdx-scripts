...
namespace Grawly.Battle.Modifiers {
	...
	/// </summary>
	[System.Serializable]
	public class TemporaryEvasionChange : CombatantModifier, IInterceptIncomingDCS, IOnTurnReady {
		...
		private static string inspectorDescription = "Targets with this modifier are more easily targeted. Gets removed after a certain amouint of time. Higher values means more likely to get hit.";
