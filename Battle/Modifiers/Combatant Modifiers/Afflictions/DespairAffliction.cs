...
namespace Grawly.Battle.Modifiers.Afflictions {
	...
	/// <summary>
	/// Cannot move. MP drained.
	/// </summary>
	public class DespairAffliction : CombatantModifier, ICombatantAffliction, IOnTurnReady, ITurnBehaviorOverride {
		...
		private string inspectorString = "Cannot move. MP drained.";
